		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PHAG Bootcamp Car-Shop",
									"targetURL": "#phagdemobootcamp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"phagdemobootcamp-display": {
								"semanticObject": "phagdemobootcamp",
								"action": "display",
								"description": "Administration of Cars",
								"title": "PHAG Bootcamp Car-Shop",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=phag.demo.bootcamp",
									"url": sap.ui.require.toUrl("phag/demo/bootcamp")
								}
							}
						}
					}
